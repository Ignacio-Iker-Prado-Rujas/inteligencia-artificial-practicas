...
%3) Ejecuta AimaDemoApp en modo aplicación para la búsqueda de caminos en el mapa de Rumanía, desde Arad a Bucharest, utilizando la búsqueda en profundidad, en anchura y el algoritmo A* con la heurística de la distancia en línea recta. Haz una tabla con los resultados obtenidos con cada algoritmo e incorpórala a la memoria. Interpreta y discute los resultados. ¿Por qué el algoritmo de búsqueda en anchura no obtiene el camino mínimo?
